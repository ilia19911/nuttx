...
#define GPIO_SX126X_NSS   (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | GPIO_PORTB | GPIO_PIN9)
#define GPIO_SX126X_RESET (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | GPIO_PORTD | GPIO_PIN14)
#define GPIO_SX126X_BUSY  (GPIO_INPUT  | GPIO_FLOAT    | GPIO_SPEED_50MHz | GPIO_PORTD | GPIO_PIN15)
#define GPIO_SX126X_DIO1  (GPIO_INPUT  | GPIO_FLOAT    | GPIO_EXTI        | GPIO_PORTB | GPIO_PIN8)
